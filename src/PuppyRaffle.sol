...
/// 5. The owner of the protocol will set a feeAddress to take a cut of the `value`, and the rest of the funds will be
/// sent to the winner of the puppy.
contract PuppyRaffle is ERC721, Ownable {
    ...
    /// @param playerIndex the index of the player to refund. You can find it externally by calling
