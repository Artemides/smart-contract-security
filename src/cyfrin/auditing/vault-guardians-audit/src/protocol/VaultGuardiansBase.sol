...
contract VaultGuardiansBase is AStaticTokenData, IVaultData {
    ...
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    //i consider indexing events for easy event querying
    event GuardianAdded(address guardianAddress, IERC20 token);
    //i event wrong spelled
     ...
     */
    //us? how do users take desition in regard to non-efficient strategy allocations?
    //ok  users analize vault guardian's strategies but once invested cannot avoid changes over strategies
    ...
    //ok does only check for supported Tokens?, yes => WETH, USDC and LINK
     ...
     */
    //us? are guardian share payments invested as well?, ok => yes
