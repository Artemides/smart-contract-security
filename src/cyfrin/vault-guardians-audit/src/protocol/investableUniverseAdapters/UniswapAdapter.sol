...
contract UniswapAdapter is AStaticUSDCData {
    ...
    function _uniswapInvest(IERC20 token, uint256 amount) internal {
        ...
        //@audit no slippage protection against MEV frontrun alteration of Pool rate on Uniswap
        //returns real outPut by addubg half tokens as liquidity
        //@audit lack of deadline, trassaction can hold by a node might be abused for MEV techniques
    ...
    function _uniswapDivest(IERC20 token, uint256 liquidityAmount) internal returns (uint256 amountOfAssetReturned) {
        ...
        //us shouldn't  divest return amount[1]+tokenAmount
        //proof
